...
| ✅ | Recording workflow | Recording helpers persist settings, toggle recorder status, and paint captured mappings inside the Recording tab via `initializeRecordingForm`, `startRecording`, `stopRecording`, and `takeRecordingSnapshot`.【F:js/features.js†L1608-L1996】【F:index.html†L333-L402】 |
