...
| ✅ | Recording workflow | `initializeRecordingForm`, `startRecording`, `stopRecording`, and `takeRecordingSnapshot` now persist form inputs, refresh the recorder status, and render captured mappings directly inside the dashboard recording list.【F:js/features.js†L1608-L1996】【F:index.html†L333-L402】 |
